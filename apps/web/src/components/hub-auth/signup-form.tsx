...
import { FACULTIES, GENDER_OPTIONS, GOVERNORATES, STUDENT_STATUS_OPTIONS, UNIVERSITIES } from '@/data/hub-registration-options';
...
export function SignupForm() {
  ...
  const { open, close } = useHubAuthModal();
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      const res = await fetch('/api/hub-auth/register', {
        method: 'POST',
